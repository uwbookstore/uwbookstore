$(document).ajaxComplete(function (_, __, options) {
  ...
  $(potentialTargets).each(function () {
    if (
      ...
      $(this).addClass('callout callout-info');
...
$(document).ready(function () {
  ...
  $('input[name=coSelectShipping]').change(function () {
    ...
    switch (shipId) {
      ...
      case '987':
        message =
          '<div class="callout callout-danger">This shipping method is valid for the shipping of Gift Cards only. If you choose this method and are purchasing anything other than a gift card, the shipping method will be corrected to "Ground Shipping" and you will be charged accordingly.<br /><br />Your order will be shipped via UPS&reg;, FedEx&reg; or USPS&reg; which will take 1-3 business days (Mon-Fri, dependent on location and shipping method chosen) to reach you.</div>';
        break;
      case '646':
      case '649':
        message =
          '<div class="callout callout-danger">Our order processing time is 1-2 business days (Mon-Fri) for expedited orders.  After your order is processed it will be shipped via UPS&reg;, FedEx&reg; or USPS&reg; which will take 1-2 business days (Mon-Fri, dependent on location and shipping method chosen) to reach you.</div>';
        break;
      case '1278':
        message =
          '<div class="callout callout-danger">This shipping method is to be used for International Orders only. If you choose this method and are shipping domestically, the shipping method will be corrected to "Ground Shipping" and you will be charged accordingly.</div>';
        break;
      case '2193':
        message =
          '<div class="callout callout-danger">This shipping method is to be used for orders over $75 (pre-tax subtotal). If you choose this method and your order total is less than $75, the shipping method will be corrected to "Ground Shipping" and you will be charged accordingly.</div>';
        break;
      case '2298':
        '<div class="callout callout-danger">*$1.28 flat rate ground shipping to a contiguous U.S. delivery address. Excludes Lands\' End items, textbooks, all StandardChair of Gardner products, custom orders, tech items, and drop-ship items. <strong>Orders with any excluded items will be charged the full standard shipping fee.</strong> All items with a handling charge will receive $1.28 ground shipping but handling charge will still be applied.</div>';
        break;
      case '970':
      case '1957':
        message =
          '<div id="shipDisclaimer" class="callout callout-danger"><strong>CONTACTLESS PICK-UP AVAILABLE</strong><br>Park in front of sandwich board in front of store.<br>Call 310-5976 when you arrive.</div>';
        break;
      case '968':
        message =
          '<div id="shipDisclaimer" class="callout callout-danger"><strong>CONTACTLESS PICK-UP AVAILABLE</strong><br>Park in valid parking spots directly across from the store<br>Call 310-5980 when you arrive.</div>';
        break;
      default:
        shipCaseFound = false;
        break;

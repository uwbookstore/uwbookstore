$(document).ready(() => {
  ...
  if ($('div.confirmationText').length) {
    ...
    if (
      ...
      $(`
          ...
          <p>If this is a question about a confirmed order please include your order number in the "Message" box. This information
            will help us respond to your message more rapidly.</p>
          <p>Your question may already be answered. We have made a list of questions that come in the most.<br><a
              href="https://www.uwbookstore.com/Customer-Help#faq" title="FAQ">FAQ</a></p>
          <p>View our <a href="https://www.uwbookstore.com/Customer-Help#return" title="Our Return Policy">return policy</a></p>      
      ...
      $(`
        ...
        <p>If this is a question about a confirmed order please include your order number in the "Message" box. This information
          will help us respond to your message more rapidly.</p>
        <p>Your question may already be answered. We have made a list of questions that come in the most.<br><a
            href="https://text.uwbookstore.com/SiteText?id=2369#faq" title="FAQ">FAQ</a></p>
        <p>View our <a href="https://text.uwbookstore.com/SiteText?id=2369#return" title="Our Return Policy">return policy</a>
        </p>
      `).appendTo('div.card-body .row > div:first-child');
      ...
      $(`
        ...
        <p>If this is a question about a confirmed order please include your order number in the "Message" box. This information
          will help us respond to your message more rapidly.</p>
        <p>View our <a href="https://www.uwbookstore.com/Customer-Help#return" target="_blank" title="Our Return Policy">return
            policy</a></p>
      `).appendTo('div.card-body .row > div:first-child');
    } else if (window.location.host === 'www.uwalumnistore.com') {
      $(`
  ...
  $('#selectedSubject').on('change', function () {
    ...
    // }
      ...
      $('#message, button.g-recaptcha.SubmitButton').show();
      $('#fname, #lname, #email').parent().show();
      $('#dntn-form').hide();
    } else if (selOpt === 1349) {
      $('#msg-text')
        .html(
          `
            If you are experiencing problems with the website, please include the following information in your message:
            <ul class="ul">
              <li>Error message(s) – (If any)</li>
              <li>What system you are on (Mac, PC, mobile device)</li>

$(document).ready(function () {
  ...
  $(
    '<div class="callout callout-warning" id="room-msg">If you are planning on having your order shipped to your dorm, please enter your dorm name and room number.</div>',
  ...
  $('#custShipAdd2').blur(function () {
    if (!this.value) {
      ...
      $(this).attr(
        'placeholder',
        'Please enter dorm, and dorm room if applicable',
      );
      // $("#room-msg").show();
    } else {

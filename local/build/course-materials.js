$(document).ready(function () {
  ...
  $('.Materials_Course').each(function (index) {
    if ($(this).is(':contains("This course does not require any course materials")')) {

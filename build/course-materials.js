$(document).ready(function () {
  ...
  $('.Materials_Course').each(function (index) {
    ...
    if ($(this).is(':contains("UZN")')) {
      ...
      $('<div class="panel-body"><p class="col-xs-12 textl alert alert-warning p-2">This course includes an eText textbook. The eText fees will be automatically charged via your tuition.</p></div>').appendTo($(this).find('.card-body:last()'));

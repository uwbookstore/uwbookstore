$(document).ready(function () {
  ...
  $('.retPolicy').html(
    'You may return your textbooks with a receipt for a full refund through Wednesday, September 13<sup>th</sup> (2022 Fall Semester), and through Tuesday, January 31<sup>st</sup> (2023 Spring Semester).'
  );
  ...
  $('.dropdown-toggle').click(function () {
    var allParents = $('.navbar-ubs').find('.dropdown');
